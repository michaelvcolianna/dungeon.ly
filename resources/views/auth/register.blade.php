    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <div class="my-2 text-gray-600 text-xs leading-normal">Public registration is currently closed. Please provide the registration key given to you by an administrator.</div>
